...
alpha = 10; % Valor del paper alpha = 5
rot = 0;
nomArxiu = "imatges/DALLE3RedChannel_L200_r175_alpha10GreenChannel_L200_r175_alpha10";
ext = ".png";
fileID = fopen("marques/marca445.txt",'r'); %Llegeix bits de la marca
...
recombinedRGBImage = cat(3, redChannel, greenChannel, imWM);
...
%}
imwrite(recombinedRGBImage, nomArxiu+"_L"+L+"_r"+r+"_alpha"+alpha+".png");
